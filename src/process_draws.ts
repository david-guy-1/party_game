...
export function fade(lst : draw_command[], c : React.RefObject<HTMLCanvasElement>,  callback ?: (a : any) => void, args : any = undefined, color : string = "black", time : number = 0.5, size : point = [1000, 1000], full : boolean = true){
    if(c.current == null){
        return;
    }
