...
export let display : display_type = {
    "button" : [["add", [100,100,100,100], "Add"],["sub", [300,100,100,100], "Subtract"]],
    "canvas" : [],
    "image" : [],
    "text":[["0", 200,200,{}]] 
}
...
export let button_click : button_click_type = function(g : game,globalStore : globalStore_type, name : string){
    ...
    let display_ = JSON.parse(JSON.stringify(display)) as display_type;
    display_.text[0][0] = g.n.toString()
    return [["change display", display_]]
}
